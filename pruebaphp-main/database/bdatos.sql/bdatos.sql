...
-- Inserción corregida: Usamos INSERT IGNORE para evitar error de email duplicado
INSERT IGNORE INTO t_usuarios VALUES 
(NULL, 'juan', 'diego', 'juandiegodelgadojerez@gmail.com', '123456', 'admin', 'imagen');

-- Tabla de categorías corregida (estándar SQL)
...
-- Inserción corregida: Usamos VALUES en plural (estándar SQL)
...
-- Tabla de productos (sin errores)
...
CREATE TABLE IF NOT EXISTS t_pedidos (
    ...
    costo         DECIMAL(10,2)      NOT NULL, -- Corregido: DECIMAL en lugar de FLOAT
